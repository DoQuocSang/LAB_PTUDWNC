            ...
            <div className='container-fluid'>
                ...
                <Nb.Collapse id='responsive-navbar-nav' className='d-sm-inline-flex justify-content-between'>
                    <Nav className='mr-auto flex-grow-1'>
                        <Nav.Item>
                            <Link to='/admin/categories' className='nav-link text-dark'> Chủ đề
                            </Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Link to='/admin/authors' className='nav-link text-dark'> Tác giả
                            </Link>
                        </Nav.Item>
                        <Nav.Item>
                        ...
                        <Nav.Item>
                            <Link to='/admin/posts' className='nav-link text-dark'> Bài viết
                            </Link>
                        </Nav.Item>
                        <Nav.Item>

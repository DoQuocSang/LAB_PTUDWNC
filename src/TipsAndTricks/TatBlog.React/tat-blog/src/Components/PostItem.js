            ...
            <Card>
                <div className='row g-0'>
                    <div className='col-md-4'>
                        ...
                        <Card.Img variant='top' src={imageUrl} alt={postItem.title} /> </div>
                    <div className='col-md-8'>
                        <Card.Body>
                            ...
                            <div className='text-end'>
                                <Link
                                    to={`/blog/post?year=${postedDate.getFullYear()}&month=${postedDate.getMonth() + 1}&day=${postedDate.getDate()}&slug=${postItem.urlSlug}`}
                                    className='btn btn-primary' title={postItem.title}>
                                    Xem chi tiết
                                </Link>
                            </div>
                        </Card.Body>
